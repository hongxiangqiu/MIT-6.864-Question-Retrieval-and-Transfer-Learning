...
model = SimpleDA(lstm.CombinedEncoder(encoding_size, glove840b.emb_size, bidirectional=True),
                 TwoLayerReLUDomainClassifier(300, 150, encoding_size))
model.load_state_dict(torch.load("./trained_models/dan_bilstm")['model'])
